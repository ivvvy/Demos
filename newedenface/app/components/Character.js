        ...
        return(
            <div className='container'>
                ...
                <div className='profile-info clearfix'>
                    ...
                    <h4 className='lead'>Race£º<strong>{this.state.race}</strong></h4>
                    <h4 className='lead'>Bloodline£º<strong>{this.state.bloodline}</strong></h4>
                    <h4 className='lead'>Gender£º<strong>{this.state.gender}</strong></h4>
                    <button className='btn btn-transparent' onClick={CharacterActions.report.bind(this,this.state.characterId)} disable={this.state.isReported}>{this.state.isReported?'Reported':'Report Character'}</button>
                </div>
                <div className='profile-stats clearfix'>
                    <ul>
                        <li><span className='stats-number'>{this.state.winLossRation}</span>Winning Percentage</li>
